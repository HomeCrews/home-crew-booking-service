# home-crew-booking-service

Booking lifecycle: create, schedule, cancel, complete.
...
|---|---|
| Port | 8084 |
| Route through the gateway | `/bookings/**` |
| Java package | `com.homecrew.bookingservice` |
| Maven artifact | `bookingservice` |
| Image | `mthanuj/homecrew-booking-service:dev` |
| Compose service | `booking-service` |
| Database | `homecrew_booking` |
| Default branch | `dev` |
...
A push to `dev` builds the image and pushes two tags to Docker Hub:
    ...
    mthanuj/homecrew-booking-service:dev
    mthanuj/homecrew-booking-service:sha-<short>
